...
<div class=" w-full h-screen justify-center items-center flex absolute top-0">
	<section
		class="flex items-center flex-col mt-4 sm:mt-8 md:mt-16 shadow py-8 sm:py-16 md:py-32 px-8 sm:px-16 md:px-32 self-center bg-white"
	>
		<!-- <h1>EzGizer</h1> -->
			...
			<p>
				...
				{:else}
					<button
						...
						class="flex w-full items-center justify-center text-white rounded-lg shadow bg-white hover:bg-gray-100"
					>
						<div class="px-4 py-3">
